class LevelCreator {
  ...
  Level level15() {
    ...
    return new Level(15, elements, powerUps, ball, startX, startY, -1, -1, false,false,new int[]{139,22,22});
  }
  Level level16() {
    float startX = 60;
    float startY = 75;
    ...
    return new Level(16, elements, powerUps, ball, startX, startY, 6, 5, false,false,new int[]{53,63,23});
  }
}
